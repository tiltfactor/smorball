var LevelData = [
    {
        ...
        "waves": {
            ...
            "data": [
                {
                    "types": ["fast", "cleats", "tallstops", "walkingBacks", "wideCenters", "coach", "helmet", "bullhorn"],
                    "time": -1,
                    "size": 6,
                    "stageDatas": []
                }
    ...
    },
    {
        ...
        "lanes": 3,
        "pass": 2,
        "levelName": "LOCAL QUALIFIERS",
        "waves": {
            "activeWaves": 1,
            "time": 1000,
            "maxOnGround": 4,
            "enemySize": 18,
            "message": "Jujubes come in 3 different rows now.",
            "data": [
                {
                    "types": ["walkingBacks"],
                    "time": -1,
    ...
    },
    {
        ...
        "lanes": 3,
        "pass": 2,
        "levelName": "STATE QUALIFIERS",
        "waves": {
            "activeWaves": 1,
            "time": 1000,
            "maxOnGround": 4,
            "enemySize": 52,
            "message": "Pick up the powerup.@@Use tab to select it",
            "data": [
                {
    ...
    },
    {
        ...
        "lanes": 3,
        "pass": 2,
        "levelName": "REGIONAL QUARTERFINALS",
        "waves": {
            "activeWaves": 1,
            "time": 1000,
            "maxOnGround": 4,
    ...
    },
    {
        ...
        "lanes": 3,
        "pass": 2,
        "levelName": "NATIONAL QUARTERFINALS",
        "waves": {
            "activeWaves": 1,
            "time": 1000,
            "maxOnGround": 4,
