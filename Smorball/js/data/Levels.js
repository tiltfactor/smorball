...
Levels[4] = { "level" : 4, "lanes" : 3 , "pass" : 2,
    "waves" : { "activeWaves" : 1, "time" : 1000, "maxOnGround" : 4,"messages":"Powerups make your next word super powerful!@@Type the word to pick up the powerup.@@ Use tab to select your powerup", "data": [
        {"types" : ["boss","ice"], "time": -1, "size" : 4, stageDatas: [["ice",2,2000,"This one deals extra damage!@@ Try it now! ","powerup"],["boss",2,20000],["ice",1,0,"","powerup"],["ice",1,0,"","powerup"]] },
        {"types" : ["boss","ice"], "time": -1, "size" : 3, stageDatas: [["boss",1,5000],["ice",3,5000,"","powerup"],["boss",2]] },
        {"types" : ["ice"], "time": -1, "size" : 3, stageDatas: [["ice",1,1,"","powerup"],["ice",2,0,"","powerup"],["ice",3,0,"","powerup"]] },
...
Levels[5] = { "level" : 5, "lanes" : 3 , "pass" : 2,
    "waves" : { "activeWaves" : 1, "time" : 1000, "maxOnGround" : 4, "data": [
        {"types" : ["regular","badGuy","ice"], "time": -1, "size" : 8, stageDatas: [["regular",2],["regular",1],["regular",1,5000],["ice",1,0,"","powerup"],["ice",2,14000,"","powerup"],["regular",3,8000],["badGuy",1,8000],["badGuy",2]] },
        ...
        {"types" : ["boss","ice"], "time": -1, "size" : 2, stageDatas: [["ice",1,0,"","powerup"],["ice",2,0,"","powerup"],["ice",3,0,"","powerup"],["boss",2,0],["boss",3,0]] }

    ]  }
}
Levels[6] = { "level" : 6, "lanes" : 3 , "pass" : 2,
    "waves" : { "activeWaves" : 1, "time" : 1000, "maxOnGround" : 4,"messages":"Pick up the powerup.@@Use tab to select it", "data": [
        {"types" : ["enemy_regular","ruby"], "time": -1, "size" : 5, stageDatas: [["ruby",1,0,"This one hit every jujube in the row@@ Try it now !","powerup"],["enemy_regular",1,2000,""],["enemy_regular",1,2000,""],["enemy_regular",1,0,""],["ruby",1,0,"","powerup"]] },
        ...
        {"types" : ["regular","ruby"], "time": -1, "size" : 9, stageDatas: [["ruby",2,0,"","powerup"],["regular",3,3000],["regular",3,3000],["regular",3,3000],["regular",3,7000],["regular",1,2000],["regular",1,2000],["regular",1,2000],["ruby",2,0,"","powerup"]] },
        {"types" : ["regular","ruby","ice","boss","badGuy","fast"], "time": -1, "size" : 17, stageDatas: [["ice",1,0,"","powerup"],["boss",2,6000],["regular",2,6000],["regular",2,6000],["ice",1,0,"","powerup"],["regular",2,6000],["regular",2,5000],["ruby",3,2000,"","powerup"],["badGuy",3,2000],["enemy_regular",1,4000],["fast",2,2000],["fast",2,2000],["fast",2,2000],["fast",2,2000],["fast",2,4000],["ice",1,0],["boss",2]]},
